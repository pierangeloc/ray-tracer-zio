...
import io.tuliplogic.raytracer.ops.model.{Color, Intersection, Material, PhongReflectionModule, Ray, RayModule, NormalReflectModule}
  ...
  "hitComps" should {
    "compute the components of a ray hitting the surface at a given intersection" in {
      unsafeRun {
        ...
        } yield ()).provide(new RayModule.BreezeMatrixOps with NormalReflectModule.BreezeMatrixOps with MatrixModule.BreezeMatrixModule with AffineTransformationOps.BreezeMatrixOps$)
      }
    }
    ...
    "compute black for a ray that doesn't intersect any object" in {
      unsafeRun {
        (for {
          ...
          .provide(new RayModule.BreezeMatrixOps with NormalReflectModule.BreezeMatrixOps with MatrixModule.BreezeMatrixModule with AffineTransformationOps.BreezeMatrixOps$ with PhongReflectionModule.BreezeMatrixOps)
      }
    }
    ...
    "equal the ambient light" in {
      unsafeRun {
        (for {
          ...
          ()).provide(new RayModule.BreezeMatrixOps with NormalReflectModule.BreezeMatrixOps with MatrixModule.BreezeMatrixModule with PhongReflectionModule.BreezeMatrixOps with AffineTransformationOps.BreezeMatrixOps$)
      }
    }
  }
